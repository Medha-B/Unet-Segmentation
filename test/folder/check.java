...
public class montardonUnet {
	
	// Logger
    private static final Logger log = LoggerFactory.getLogger(montardonUnet.class);
    ...
    public static void main(String[] args) throws IOException {
        ...
        DL4JResources.setBaseDirectory(new File("C:\\Users\\Subroto\\Documents\\deeplearningjava"));
        ...
        try {
            ...
            for (int i=0; i < numSamples; i++) {
                images[i] = new File("C:\\Users\\Subroto\\Desktop\\img_mont\\img"+i+".png");
                labels[i] = new File("C:\\Users\\Subroto\\Desktop\\label_mont\\label"+i+".png");
            }

            //Then add the StatsListener to collect this information from the network, as it trains
            model.setListeners(new PerformanceListener(5),new ScoreIterationListener(5));
